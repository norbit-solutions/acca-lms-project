/**
 * Common Icons
 * Reusable SVG icon components for the entire application
 */
...
// Play Circle Icon (for continue watching)
...
export const BackIcon = ({ className = "w-5 h-5" }: { className?: string }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
// Users Icon (multiple users / group)
export const UsersIcon = ({ className = "w-10 h-10" }: { className?: string }) => (
