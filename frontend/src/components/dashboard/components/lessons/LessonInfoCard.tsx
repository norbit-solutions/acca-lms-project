            ...
            {duration && (
              <div className="bg-gray-50 rounded-xl p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-lg font-semibold text-black">{formatDuration(duration)}</p>
              ...
              <div className="flex items-center gap-3">
                <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                  ...
                  <svg className={`w-5 h-5 ${
                    ...
                    viewsRemaining === 1 ? 'text-amber-600' : 'text-black'
                ...
                <div>
                  <p className={`text-lg font-semibold ${
                    ...
                    viewsRemaining === 1 ? 'text-amber-700' : 'text-black'
                  }`}>
                    {viewsRemaining} left
                  </p>
                  <p className="text-xs text-gray-500">{viewCount}/{maxViews} views</p>
                </div>
              </div>
            </div>
          </div>
