      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-3 gap-4 mb-6">
          <div className="bg-gray-50 rounded-xl p-4 text-center">
            ...
            <div className="text-2xl font-thin text-black">{chaptersCount}</div>
          ...
          <div className="bg-gray-50 rounded-xl p-4 text-center">
            ...
            <div className="text-2xl font-thin text-black">{lessonsCount}</div>
            <div className="text-xs text-gray-500 uppercase tracking-wide">Lessons</div>
          </div>
